...
<section class="shortcode-accordion-section section-padding pt-0 pb-0">
    <div class="container-fluid"  style="background-image: url(../assets/img/1.png)"><br>
        <div class="container">
            <div class="h4-title">  Mr. S.P.D. Danushka   </div><br>
            <h5 class="ml-4">  M.Sc.Eng. Student </h5>
            <div class="row">
                <div class="col-md-3 col-sm-6 p-5">

                    <img class="img-responsive6" style="background-color: #666666" src="../assets/img/resstudents/MrSPDDanushka.jpg">
                </div>
                <div class="col-md-9 col-sm-6" style="line-height: normal">
                 <br><br>
                    <p style="font-weight: bold">Email: <a href="#" style=" font-weight: normal">dilandanushka@eng.pdn.ac.lk</a></p>
                    <p style="font-weight: bold">Telephone: <a style="font-weight:normal">+94-76-5336754
</a></p>
                </div>
            </div>
             
			 
Mr. S.P.D. Danushka is an M.Sc.Eng. candidate affiliated to Structures Laboratory at the Department of Civil Engineering, University of Peradeniya.
 <br><br>
            ...
            <tbody>
              <tr> 
                ...
                <td width="85%" style="text-align: top-left"> A historical approach for damage identification, quantification and prognosis of pre-stressed / post-tensioned concrete girder bridges based on computational intelligence techniques.<br>
                    <br>
                  </td>
              </tr>
              <tr> 
