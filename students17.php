...
<?php require '../assets/php/headerpeople.php'; ?>
 ...
 <section class="shortcode-accordion-section section-padding pt-0 pb-0">
  ...
  <div class="col-md-9 mb-lg-5" >
            ...
            <div class="h7">E/17 Students</div><br>
<div class="row ml-1 mt-5 mb-5 mr-1"> 
		
		<?php
			 
			  $csvFile = "../assets/csv/E17_stud_db.csv";
				$csv = readCSV($csvFile);
          		foreach ($csv as $key) {
															
                 	if($key[0]=="E/17"){
						$dir = "../assets/img/students/2017/".$key[8].".JPG";		

			 
			 if (file_exists($dir)) {
             			print("<div class='col-sm-3 col-md-2'>");
							print("<div class='span'><img src='../assets/img/students/2017/".$key[8].".JPG' class='img-polaroid' style='margin:5px 0px 15px;'></div>");
