...
<section class="shortcode-accordion-section section-padding pt-0 pb-0">
    <div class="container-fluid"  style="background-image: url(../assets/img/1.png)"><br>
        <div class="container">
            <div class="h4-title">  Ms. T. Abirami
 </div><br>
            <h5 class="ml-4"> M.Phil. Student </h5>
            <div class="row">
                <div class="col-md-3 col-sm-6 p-5">

                    <img class="img-responsive6" style="background-color: #666666" src="../assets/img/resstudents/MsTAbirami.jpg">
                </div>
                <div class="col-md-9 col-sm-6" style="line-height: normal">
                 <br><br>
                    <p style="font-weight: bold">Email: <a href="#" style=" font-weight: normal">thuraisingamabirami@gmai.com</a></p>
                    <p style="font-weight: bold">Telephone: <a style="font-weight:normal">+94-769458597
</a></p>
                </div>
            </div>
             
			 
Ms. T. Abirami is an M.Phil. candidate affiliated to Structures Laboratory in the Department of Civil Engineering, University of Peradeniya.
 <br><br>
            ...
            <tbody>
              <tr> 
                ...
                <td width="85%" style="text-align: top-left">Sustainable construction practice through preparation of precast concrete blocks using construction demolition and plastic waste.<br>
                    <br>
                  </td>
              </tr>
              <tr> 
