...
<section class="shortcode-accordion-section section-padding pt-0 pb-0">
    <div class="container-fluid"  style="background-image: url(../assets/img/1.png)"><br><br><br>
        <div class="container">
            <div class="h4-title">  D. M. A. Devindi  </div><br>
            <h5 class="ml-4"> M.Sc.Eng. Student </h5>
            <div class="row">
                <div class="col-md-3 col-sm-6 p-5">

                    <img class="img-responsive6" style="background-color: #666666" src="../assets/img/resstudents/MsDMADevindi.jpg">
                </div>
                <div class="col-md-9 col-sm-6" style="line-height: normal">
                 <br><br>
                    <p style="font-weight: bold">Email: <a href="#" style=" font-weight: normal"> avishkadissanayake19@gmail.com </a></p>
                    <p style="font-weight: bold">Telephone: <a style="font-weight:normal">+94-76-8772000
</a></p>
                </div>
            </div>
             
			 
Ms. D. M. A. Devindi  is an M.Sc.Eng. candidate affiliated to Geotechnical Laboratory at the Department of Civil Engineering, University of Peradeniya.
 <br><br>
            ...
            <tbody>
              <tr> 
                ...
                <td width="85%" style="text-align: top-left"> Transport of Dissolved Contaminants in Texturally Heterogeneous Porous Media  <br>
                    <br>
                  </td>
              </tr>
              <tr> 
                <td width="20%" style="text-align: top-left"><b>Research Supervisors</b></td>
                <td width="85%" style="text-align: top-left"> Dr. T. K. K. C. Deepagoda <br>
