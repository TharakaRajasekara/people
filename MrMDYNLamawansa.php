...
<section class="shortcode-accordion-section section-padding pt-0 pb-0">
    <div class="container-fluid"  style="background-image: url(../assets/img/1.png)"><br><br><br>
        <div class="container">
            <div class="h4-title">  Mr. M.D.Y.N. Lamawansa </div><br>
            <h5 class="ml-4">  M.Phil. Student </h5>
            <div class="row">
                <div class="col-md-3 col-sm-6 p-5">

                    <img class="img-responsive6" style="background-color: #666666" src="../assets/img/resstudents/MrMDYNLamawansa.jpg">
                </div>
                <div class="col-md-9 col-sm-6" style="line-height: normal">
                 <br><br>
                    <p style="font-weight: bold">Email: <a href="#" style=" font-weight: normal"> e14191@eng.pdn.ac.lk </a></p>
                    <p style="font-weight: bold">Telephone: <a style="font-weight:normal">+94-71-4642473</a></p>
                </div>
            </div>
             
			 
Mr. M.D.Y.N. Lamawansa  is an M.Phil. candidate affiliated to Computer Aided Design  Laboratory in the Department of Civil Engineering, University of Peradeniya.
...
<table class="table table-hover table-responsive table-bordered ">
            <tbody>
              <tr> 
                ...
                <td width="85%" style="text-align: top-left">POST-PEAK BEHAVIOUR OF REINFORCED CONCRETE ELEMENTS<br>
                    <br>
                  </td>
              </tr>
              <tr> 
                <td width="20%" style="text-align: top-left"><b>Research Supervisors</b></td>
                <td width="85%" style="text-align: top-left">DR. K.K. Wijesundara<br>
            ...
            <div class="panel panel-default">
                ...
                <div id="collapseSix-6" class="collapse " role="tabpanel" aria-labelledby="headingSix-6">
                    <div class="panel-body clearfix panel-border">
                        ...
                        <ul>
                            <li> Lamawansa, M.D.Y.N., Hippola, H.M.S.S., Wijesundara, K.K., 2021. Evaluation of Shear Critical Reinforced Concrete Element Behavior using Different Numerical Approaches. Proceedings of Annual Sessions of Society of Structural Engineers - Sri Lanka, pp. 14-21.  </li>
