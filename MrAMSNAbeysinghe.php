...
<section class="shortcode-accordion-section section-padding pt-0 pb-0">
    <div class="container-fluid"  style="background-image: url(../assets/img/1.png)"><br><br><br>
        <div class="container">
            <div class="h4-title"> Mr. A.M.S.N. Abeysinghe </div><br>
            <h5 class="ml-4">  M.Sc.Eng. Student </h5>
            <div class="row">
                <div class="col-md-3 col-sm-6 p-5">

                    <img class="img-responsive6" style="background-color: #666666" src="../assets/img/resstudents/Mr_AMSNAbeysinghe.jpg">
                </div>
                <div class="col-md-9 col-sm-6" style="line-height: normal">
                 <br><br>
                    <p style="font-weight: bold">Email: <a href="#" style=" font-weight: normal"> snabey96@gmail.com </a></p>
                    <p style="font-weight: bold">Telephone: <a style="font-weight:normal">+94-70-2256021</a></p>
                </div>
            </div>
             
			 
Mr. A.M.S.N. Abeysinghe is an M.Sc.Eng. candidate affiliated to Geotechnical Laboratory in the Department of Civil Engineering, University of Peradeniya.
          ...
          <table class="table table-hover table-responsive table-bordered ">
            <tbody>
              <tr> 
                ...
                <td width="85%" style="text-align: top-left">Characterization and Development of an Optimized Stabilization Technique for Expansive Soils in the Central Province of Sri Lanka<br>
                    <br>
                  </td>
              </tr>
              <tr> 
                <td width="20%" style="text-align: top-left"><b>Research Supervisors</b></td>
                <td width="85%" style="text-align: top-left">Dr. L.C. Kurukulasuriya, <br>
Dr. M.C.M. Nasvi
