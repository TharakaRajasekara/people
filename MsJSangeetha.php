...
<section class="shortcode-accordion-section section-padding pt-0 pb-0">
    <div class="container-fluid"  style="background-image: url(../assets/img/1.png)"><br><br><br>
        <div class="container">
            <div class="h4-title"> Ms. J. Sangeetha  </div><br>
            <h5 class="ml-4">  M.Sc.Eng. Student </h5>
            <div class="row">
                <div class="col-md-3 col-sm-6 p-5">

                    <img class="img-responsive6" style="background-color: #666666" src="../assets/img/resstudents/MsJSangeetha.jpg">
                </div>
                <div class="col-md-9 col-sm-6" style="line-height: normal">
                 <br><br>
                    <p style="font-weight: bold">Email: <a href="#" style=" font-weight: normal">   sangeethajeyathasan@eng.pdn.ac.lk  </a></p>
                    <p style="font-weight: bold">Telephone: <a style="font-weight:normal">+94-76-6654889</a></p>
                </div>
            </div>
             
			 
 Ms. J. Sangeetha  is an M.Sc.Eng. candidate affiliated to Geotechnical Laboratory in the Department of Civil Engineering, University of Peradeniya.
...
<table class="table table-hover table-responsive table-bordered ">
            <tbody>
              <tr> 
                ...
                <td width="85%" style="text-align: top-left"> Feasibility of using blended fly ash,rice husk ash, and lime treated marginal soil for road construction in Sri Lanka <br>
                    <br>
                  </td>
              </tr>
              <tr> 
                <td width="20%" style="text-align: top-left"><b>Research Supervisors</b></td>
                <td width="85%" style="text-align: top-left"> Dr. M.C.M.Nasvi
            ...
            <div class="panel panel-default">
                ...
                <div id="collapseSix-6" class="collapse " role="tabpanel" aria-labelledby="headingSix-6">
                    <div class="panel-body clearfix panel-border">
                        ...
                        <ul>
                            <li> J. Sangeetha, J. Dalshica, and M.C.M. Nasvi (2020). “Stabilizer Design for Deep Soil Mixing Using Fly Ash to Stabilize Expansive Soil”, International Conference on Geotechnical Engineering, ICGE Colombo 2020  </li>
