...
<section class="shortcode-accordion-section section-padding pt-0 pb-0">
    <div class="container-fluid"  style="background-image: url(../assets/img/1.png)"><br>
        <div class="container">
            <div class="h4-title">Mr. A.C.D. Pigera</div><br>
            <h5 class="ml-4"> M.Sc.Eng. Student </h5>
            <div class="row">
                <div class="col-md-3 col-sm-6 p-5">

                    <img class="img-responsive6" style="background-color: #666666" src="../assets/img/resstudents/MrACDPigera.jpg">
                </div>
                <div class="col-md-9 col-sm-6" style="line-height: normal">
                 <br><br>
                    <p style="font-weight: bold">Email: <a href="#" style=" font-weight: normal">chamathdulanjana@gmail.com</a></p>
                    <p style="font-weight: bold">Telephone: <a style="font-weight:normal">+94-778116448
</a></p>
                </div>
            </div>
             
			 
Mr. A.C.D. Pigera is an M.Sc.Eng. candidate affiliated to Structures Laboratory at the Department of Civil Engineering, University of Peradeniya.
 <br><br>
            ...
            <tbody>
              <tr> 
                ...
                <td width="85%" style="text-align: top-left">Investigating the Low-Cycle Fatigue Behaviour of Steel Hollow Piers under Seismic Loading<br>
                    <br>
                  </td>
              </tr>
              <tr> 
                <td width="20%" style="text-align: top-left"><b>Research Supervisors</b></td>
                <td width="85%" style="text-align: top-left">Dr. J.A.S.C. Jayasinghe<br>
                                                    Prof. C.S. Bandara
