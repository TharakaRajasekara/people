...
<section class="shortcode-accordion-section section-padding pt-0 pb-0">
    <div class="container-fluid"  style="background-image: url(../assets/img/1.png)"><br><br><br>
        <div class="container">
            <div class="h4-title">  Ms. S.Mathuranthagi  </div><br>
            <h5 class="ml-4">  M.Sc.Eng. Student </h5>
            <div class="row">
                <div class="col-md-3 col-sm-6 p-5">

                    <img class="img-responsive6" style="background-color: #666666" src="../assets/img/resstudents/MsSMathuranthagi.jpg">
                </div>
                <div class="col-md-9 col-sm-6" style="line-height: normal">
                 <br><br>
                    <p style="font-weight: bold">Email: <a href="#" style=" font-weight: normal"> mathushiva15@gmail.com </a></p>
                    <p style="font-weight: bold">Telephone: <a style="font-weight:normal">+94-76-9232385
</a></p>
                </div>
            </div>
             
			 
Ms. S.Mathuranthagi  is an M.Sc.Eng. candidate affiliated to Geotechnical Laboratory at the Department of Civil Engineering, University of Peradeniya.
 <br><br>
            ...
            <tbody>
              <tr> 
                ...
                <td width="85%" style="text-align: top-left">  Colloid-Facilitated Transport of Agrochemicals in CKDu affected areas in Sri Lanka <br>
                    <br>
                  </td>
              </tr>
              <tr> 
            ...
            <div class="panel panel-default">
                ...
                <div id="collapseSix-6" class="collapse " role="tabpanel" aria-labelledby="headingSix-6">
                    <div class="panel-body clearfix panel-border">
                        ...
                        <ul>
                            <li>  Mathuranthagi.S, Rajeevan.N and Dr.B.Ketheesan (2019) Lower Cost Treatment Method for Algal Removal in Dri Aru Water Treatment Plant, 5th International Conference on Dry Zone Agriculture, Kilinochchi. pp79.  </li>
