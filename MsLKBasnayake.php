...
<body>
    ...
    <section class="shortcode-accordion-section section-padding pt-0 pb-0">
        <div class="container-fluid" style="background-image: url(../assets/img/1.png)"><br>
            <div class="container">
                <div class="h4-title"> Ms. L K Basnayake </div><br>
                <h5 class="ml-4"> Ph.D. Student </h5>
                <div class="row">
                    <div class="col-md-3 col-sm-6 p-5">

                        <img class="img-responsive6" style="background-color: #666666" src="../assets/img/resstudents/MsLKBasnayake.jpg">
                    </div>
                    <div class="col-md-9 col-sm-6" style="line-height: normal">
                        <br><br>
                        <p style="font-weight: bold">Email: <a href="#" style=" font-weight: normal"> lakminipera10@gmail.com </a></p>
                        <p style="font-weight: bold">Telephone: <a style="font-weight:normal">+94-71-9044829</a></p>
                        <p style="font-weight:normal">+94- 74-3881684</p>
                    </div>
                </div>


                Ms. L K Basnayake is a Ph.D. candidate in the Department of Civil Engineering, University of Peradeniya.
                ...
                <table class="table table-hover table-responsive table-bordered ">
                    <tbody>
                        <tr>
                            ...
                            <td width="85%" style="text-align: top-left">Towards Physics-Based Analysis and Design of Durable Concrete Incorporating
                                Calcined Clay as Supplementary Cementitious Materials<br>
                                <br>
                            </td>
                        </tr>
                        <tr>
