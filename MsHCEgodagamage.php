...
<section class="shortcode-accordion-section section-padding pt-0 pb-0">
    <div class="container-fluid"  style="background-image: url(../assets/img/1.png)"><br><br><br>
        <div class="container">
            <div class="h4-title"> Ms. H.C. Egodagamage  </div><br>
            <h5 class="ml-4"> Ph.D. Student </h5>
            <div class="row">
                <div class="col-md-3 col-sm-6 p-5">

                    <img class="img-responsive6" style="background-color: #666666" src="../assets/img/resstudents/MsHCEgodagamage.jpg">
                </div>
                <div class="col-md-9 col-sm-6" style="line-height: normal">
                 <br><br>
                    <p style="font-weight: bold">Email: <a href="#" style=" font-weight: normal"> harshiegamage@gmail.com </a></p>
                    <p style="font-weight: bold">Telephone: <a style="font-weight:normal">+94-71-3480120</a></p>
                </div>
            </div>
             
			 
Ms. H.C. Egodagamage is a Ph.D. candidate under  RMIT-UoP split   programme affiliated to  Material Laboratory in the Department of Civil Engineering, University of Peradeniya.
 ...
 <br><br>
            ...
            <tbody>
              <tr> 
                ...
                <td width="85%" style="text-align: top-left">Aerated Alkali Activated Slag in Prefabricated Modular Construction<br>
                    <br>
                  </td>
              </tr>
              <tr> 
...
<br>
Dr. Satheeskumar Navaratnam (RMIT)
