...
<section class="shortcode-accordion-section section-padding pt-0 pb-0">
    <div class="container-fluid"  style="background-image: url(../assets/img/1.png)"><br><br><br>
        <div class="container">
            <div class="h4-title"> Ms. W. M. A. D. Wijethunge  </div><br>
            <h5 class="ml-4">  M.Phil. Student </h5>
            <div class="row">
                <div class="col-md-3 col-sm-6 p-5">

                    <img class="img-responsive6" style="background-color: #666666" src="../assets/img/resstudents/MsWMADWijethunge.jpg">
                </div>
                <div class="col-md-9 col-sm-6" style="line-height: normal">
                 <br><br>
                    <p style="font-weight: bold">Email: <a href="#" style=" font-weight: normal"> akilawijethunge@gmail.com </a></p>
                    <p style="font-weight: bold">Telephone: <a style="font-weight:normal">+94-71-7653085</a></p>
                </div>
            </div>
             
			 
 Ms. W. M. A. D. Wijethunge  is an M.Phil. candidate affiliated to Structures Laboratory in the Department of Civil Engineering, University of Peradeniya.
...
<table class="table table-hover table-responsive table-bordered ">
            <tbody>
              <tr> 
                ...
                <td width="85%" style="text-align: top-left">Numerical  Investigation on Lateral Distortional Buckling in Steel Concrete Composite Beams<br>
                    <br>
                  </td>
              </tr>
              <tr> 
                <td width="20%" style="text-align: top-left"><b>Research Supervisors</b></td>
                <td width="85%" style="text-align: top-left">Dr. A.J.Dammika, <br>
Dr. C.S.Bandara
            ...
            <div class="panel panel-default">
                ...
                <div id="collapseSix-6" class="collapse " role="tabpanel" aria-labelledby="headingSix-6">
                    <div class="panel-body clearfix panel-border">
                        ...
                        <ul>
                            <li> Karunananda, K.,Herath, C.K, Madusanka, W.S.,Wijethunge, A.D.'' Effect of Loading Sequence in fatigue life prediction of 130 year old Railway bridge'', 10th International Conference on Structural Engineering and Construction Management 2019. </li>
