...
<section class="shortcode-accordion-section section-padding pt-0 pb-0">
    <div class="container-fluid"  style="background-image: url(../assets/img/1.png)"><br><br><br>
        <div class="container">
            <div class="h4-title"> Mr. L. N. Dissanayake  </div><br>
            <h5 class="ml-4">  M.Sc.Eng. Student </h5>
            <div class="row">
                <div class="col-md-3 col-sm-6 p-5">

                    <img class="img-responsive6" style="background-color: #666666" src="../assets/img/resstudents/MrLNDissanayake.jpg">
                </div>
                <div class="col-md-9 col-sm-6" style="line-height: normal">
                 <br><br>
                    <p style="font-weight: bold">Email: <a href="#" style=" font-weight: normal"> e15085@eng.pdn.ac.lk </a></p>
                    <p style="font-weight: bold">Telephone: <a style="font-weight:normal">+94-70-3263736</a></p>
                </div>
            </div>
             
			 
Mr. L. N. Dissanayake is an M.Sc.Eng. candidate  affiliated to Structures Laboratory in the Department of Civil Engineering, University of Peradeniya.
       ...
       <table class="table table-hover table-responsive table-bordered ">
            <tbody>
              <tr> 
                ...
                <td width="85%" style="text-align: top-left"> Strengthening University-Enterprise Collaboration for Resilient Communities in Asia
 <br>
                    <br>
                  </td>
              </tr>
              <tr> 
                ...
                <td width="85%" style="text-align: top-left">Dr. C. S. Bandara, <br>
            ...
            <div class="panel panel-default">
                ...
                <div id="collapseSix-6" class="collapse " role="tabpanel" aria-labelledby="headingSix-6">
                    <div class="panel-body clearfix panel-border">
                        ...
                        <ul>
                            <li> Dissanayake, L.N., Costa, D.S.T. and Wijesundara, K.K. (2021). Application of Virtual Element Method on Plane Strain and Plane Stress Problems. 11th International Conference on Structural Engineering and Construction Management. Kandy, Sri Lanka. </li>

                            <li>  Dissanayake, L.N. (2018). Application of Green Building Concept in Sri Lanka. International Student Conference on Environment and Sustainability. Tongji University, Shanghai, China </li>
