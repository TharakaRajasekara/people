...
<section class="shortcode-accordion-section section-padding pt-0 pb-0">
    <div class="container-fluid"  style="background-image: url(../assets/img/1.png)"><br><br><br>
        <div class="container">
            <div class="h4-title">   Ms. K.S.D.M. Fernando  </div><br>
            <h5 class="ml-4"> Ph.D.  Student </h5>
            <div class="row">
                <div class="col-md-3 col-sm-6 p-5">

                    <img class="img-responsive6" style="background-color: #666666" src="../assets/img/resstudents/MsKSDMFernando.jpg">
                </div>
                <div class="col-md-9 col-sm-6" style="line-height: normal">
                 <br><br>
                    <p style="font-weight: bold">Email: <a href="#" style=" font-weight: normal">  sarah.fernando93@eng.pdn.ac.lk  </a></p>
                    <p style="font-weight: bold">Telephone: <a style="font-weight:normal">+94-71-7455321 </a></p>
                </div>
            </div>
             
			 
Ms. K.S.D.M. Fernando is a Ph.D. candidate under RMIT-UoP split   programme affiliated to Geotechnical  Laboratory in the Department of Civil Engineering, University of Peradeniya.
 ...
 <br><br>
            ...
            <tbody>
              <tr> 
                ...
                <td width="85%" style="text-align: top-left">Performances of fly ash-Rice husk ash blended alkali activated binders<br>
                    <br>
                  </td>
              </tr>
              <tr> 
                <td width="20%" style="text-align: top-left"><b>Research Supervisors</b></td>
                <td width="85%" style="text-align: top-left">Dr. MCM Nasvi (UOP), <br>
Prof. Ranjith Dissanayake (UOP),
