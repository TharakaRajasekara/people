...
<?php require '../assets/php/headerpeople.php'; ?>
          ...
          <div id="accor-2" class="accordion-body collapse in" aria-expanded="true" style=""> 
            <div class="accordion-inner"> 
              <ul class="list-unstyled">
                ...
                <li> <a class="" href="sem_coordinator.php">Academic Coordinators</a> 
                </li>
              </ul>
            </div>
          </div>
 ...
 <div class="panel panel-default">
            ...
            <h1 align="left" class="panel-title"><a href="../people/students15.php" class="btn btn-common btn-xs  right" style="width: 60%" target="_blank"><b>E/15 Undergraduate Students - Final Year</b></a></h1>
          </div>
  
          <div class="panel-heading" role="tab" id="headingTwo-2"> 
            <h1 align="left" class="panel-title"><a href="../people/students16.php" class="btn btn-common btn-xs  right" style="width: 60%" target="_blank"><b>E/16 Undergraduate Students - Final Year</b></a></h1>
          </div>
          
            <div class="panel-heading" role="tab" id="headingTwo-2"> 
            <h1 align="left" class="panel-title"><a href="../people/students17.php" class="btn btn-common btn-xs  right" style="width: 60%"><b>E/17 Undergraduate Students - Final Year</b></a></h1>
          </div>-->
     <div class="panel-heading" role="tab" id="headingTwo-2"> 
         <h1 align="left" class="panel-title"><a href="../people/students18.php" class="btn btn-common btn-xs  right" style="width: 60%"><b>E/18 Undergraduate Students - Final Year</b></a></h1>
          </div>
           <div class="panel-heading" role="tab" id="headingTwo-2"> 
         <h1 align="left" class="panel-title"><a href="../people/students19.php" class="btn btn-common btn-xs  right" style="width: 60%"><b>E/19 Undergraduate Students - Third Year</b></a></h1>
          </div>  
           <div class="panel-heading" role="tab" id="headingTwo-2"> 
               <h1 align="left" class="panel-title"><a href="../people/students20.php" class="btn btn-common btn-xs  right" style="width: 60%"><b>E/20 Undergraduate Students - Second Year</b></a></h1>
          </div>               
